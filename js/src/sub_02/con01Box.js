...
(function($){
  ...
  var con01Arr = [
      { 'intro': {'title':'\"자연 그대로의 맛\"',
                  ...
                  'subBackup':'웅진식품은 일반 주스 시장에 이어 어린이를 위해 유기농 과채로 만든 \‘자연은 잘자란 유기농\’ 과일의 생생한 맛을 살린 착즙주스 \‘자연은 착즙100\’ 등을 선보였습니다.',
      ...
      { 'intro': {'title':'\"믿을 수 있는 원료\"',
                  ...
                  'subBackup':'세계 최초의 쌀 음료로 음료에 한국의 고유 문화를 담아냈다는 평가를 받는 \‘아침햇살\’ 또한 100% 국내산 쌀과 현미로 만들어져 더욱 고소하고 건강합니다.',
      ...
      { 'intro': {'title':'\"고객을 위한 도전!\"',
                  ...
                  웅진식품은 현재 해외특허 6건을 포함해서, 총 30건의 식음료 제조관련 특허를 보유하고 있습니다.',
                  'subBackup':'<br />\
